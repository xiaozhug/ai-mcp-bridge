...
public class RestToMcpToolClientApplication {

    public static void main(String[] args) {
        ConfigurableApplicationContext applicationContext = SpringApplication.run(RestToMcpToolClientApplication.class, args);
