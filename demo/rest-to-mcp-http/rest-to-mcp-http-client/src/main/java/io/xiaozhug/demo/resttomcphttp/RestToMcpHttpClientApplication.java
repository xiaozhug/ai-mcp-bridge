...
public class RestToMcpHttpClientApplication {

    public static void main(String[] args) {
        ConfigurableApplicationContext applicationContext = SpringApplication.run(RestToMcpHttpClientApplication.class, args);
